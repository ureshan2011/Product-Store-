...
import com.shop.webapp.entities.Productentity;
 ...
 */
@Stateless
@Path("com.shop.webapp.entities.productentity")
public class ProductentityFacadeREST extends AbstractFacade<Productentity> {

    @PersistenceContext(unitName = "com.shop_webapp_war_1.0-SNAPSHOTPU")
